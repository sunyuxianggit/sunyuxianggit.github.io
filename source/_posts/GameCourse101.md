...
透视投影转换正交投影
![](2020-03-20-10-11-54.png)
遮挡和可见性

#### 透视投影近平面推导
![](2020-03-20-17-32-24.png)
...
通过长宽比，我们可以推出垂直可视角度
![](2020-03-20-18-29-26.png)
也就是说，只要给定宽高比和垂直可视角度，我们就可以创建一个视锥.
#### 什么是MVP
![](2020-03-20-19-07-00.png)
* M
物体自身位移
* V
...
![](2020-03-22-19-01-28.png)

接下来就是把（-1，1）3这个标准空间映射到屏幕上，首先有一个问题就是 xyz 到xy，怎么处理z呢？  
先不管它，那就是等于是把xy屏幕（-1，1）2 映射到（0，width）*（0，height），怎么做呢？  
![](2020-03-22-22-49-41.png)
注意这里注意变完之后,中心还在屏幕坐标的中心在左下角，我们要移动中心到屏幕的中心，所以最后一列是有内容的。   

#### 光栅化，三角形到像素
![](2020-03-23-17-04-35.png)

几种光栅化显示设备： 
* 示波器
![](2020-03-23-17-08-13.png)

![](2020-03-23-17-12-53.png)
为了使画面刷新快，利用视觉暂留技术，每次只画一半，画完奇数行画偶数行，这种技术叫隔行扫描。
现在在视频压缩里面还有应用。

![](2020-03-23-17-16-28.png)
给我一个显示器，我怎么知道他要显示什么呢？通过显存里面的一块区域，把这块区域映射到屏幕上，这里就是现在屏幕的显示方式，我们可以生成不同的图形，存储在不同的显示区域，告诉显示器到底显示哪一幅图。

![](2020-03-23-17-21-35.png)
* 平板显示器  
低分辨率：计算器  
高分辨率：视网膜屏  
![](2020-03-23-17-23-13.png)
通过液晶的扭曲，改变通过它的光的扭曲水平。  

![](2020-03-23-17-25-13.png)
* 发光二极管  

![](2020-03-23-17-26-41.png)
* 电子墨水屏

![](2020-03-23-17-28-05.png)
![](2020-03-23-17-28-18.png)
![](2020-03-23-17-29-43.png)
![](2020-03-23-17-30-33.png)

![](2020-03-23-17-30-11.png)
为什么是三角形
* 最基础的多边形,可以分解任何其它多边形
* 特殊的属性。
    * 给定任意三个点，练成三角形都是一个平面。
...
![](2020-03-23-17-40-16.png)
判断一个像素和三角形的位置关系，或者说通过像素的中心点判断和三角形的位置关系。

一个简单的做法：
![](2020-03-23-17-42-26.png)
通过采样，
什么是采样：
![](2020-03-23-17-42-56.png)
采样就是把一个函数给离散化的过程。比如定义一个函数 F(X) = sin（X），然后不停的带入x=1，到x=100，看对应的F(X)的值。
45.02
